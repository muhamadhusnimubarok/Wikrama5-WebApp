  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        ...
        const kelas11 = data.filter(m => getKelas(m.tahun_masuk) === '11');

        const formatted = kelas11.map(m => ({
          id: m.id,
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-6 md:p-10 font-sans">
      ...
      <div className="text-center mb-8 w-full max-w-6xl">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-2">Profil Kelas 11</h1>
