  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        ...
        const kelas12 = data.filter(m => getKelas(m.tahun_masuk) === '12');
        const formatted = kelas12.map(m => ({
          id: m.id,
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-6 md:p-10 font-sans">
      ...
      <div className="text-center mb-8 w-full max-w-6xl">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-2">Profil Kelas 12</h1>
